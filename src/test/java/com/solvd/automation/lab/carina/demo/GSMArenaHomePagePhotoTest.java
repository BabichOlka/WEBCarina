...
import com.solvd.automation.lab.carina.demo.locators.PhonePageLocators;
...
public class GSMArenaHomePagePhotoTest extends AbstractTest {

    private WebDriver driver = getDriver();
    private static DriverHelper driverHelper;

    private static final Logger LOGGER = Logger.getLogger(GSMArenaHomePagePhotoTest.class);

    public static final List<By> PHONE_PAGE_ELEMENTS = Arrays.asList(
            PhonePageLocators.PhoneElements.MODEL, PhonePageLocators.PhoneElements.PHOTO, PhonePageLocators.PhoneElements.SPEC_LIST );
